...
import 'package:nemorixpay/features/asset/presentation/widgets/asset_card.dart';
import 'package:nemorixpay/features/asset/presentation/widgets/home_header.dart';
import 'package:nemorixpay/features/asset/presentation/widgets/live_price_tile.dart';
...
class _HomeScreenState extends State<HomePage> {
  ...
  List<AssetEntity> _searchResults = mockCryptos;
  ...
  List<AssetEntity> get myAssets => mockCryptos.take(5).toList();
  // TODO For testing purposes ----------------------------------
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      ..._searchResults.map(
                        (asset) => LivePriceTile(asset: asset),
                      ),
                    ],
                  ),
                ),
